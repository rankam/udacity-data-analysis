...
ggplot(roc.df,aes(1-specificities, sensitivities)) + geom_line(aes(), size=1.5) + xlab('1 - Specificity (False Positive Rate)') + ylab('Sensitivity (True Positive Rate)') + annotate("text",x=.8,y=0.95,label=paste('The Area Under the Curve is',auc))
```
