<h2><center>2012 Presidential Campaign Donations in Ohio</center></h2>
<p><center><h3>Aaron Rank</h3></center>
<hr>
...
```{r  message=FALSE, warning=FALSE, Additional_Features}
...
```{r  message=FALSE, warning=FALSE,Multivariate_Plots}
...
Logistic regression is an extension of the linear regression model with two important differences - the outcome variable and the error terms.
  ...
  <span style="font-weight:bold">Outcome Variable</span><p>
  ...
  <span style="font-weight:bold">Error Terms</span><p>
...
Substituting the definition of $\pi(x)$ into this equation yields (after a little algebra)
$${OR = }\; \epsilon^\beta$$
...
```{r  message=FALSE, warning=FALSE, message=F, warning=F}
...
####Resources
  - http://www.uphs.upenn.edu/radiology/education/resources/documents/Receiver-operator-characteristic-analysis-primer.pdf
  - http://www.dataschool.io/roc-curves-and-auc-explained/
  - Lecture Notes - General Assembly's Introduction to Data Science taught by Jason Dolatshahi.
