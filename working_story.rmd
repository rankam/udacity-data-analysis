...
constant variance. In logistic regression, the outcome variable can only be 0 or 1. Because of this, we can see that the error terms of logistic regression follow a Bernoulli distribution:
